...
export abstract class ProjectViewItem extends vscode.TreeItem {
  ...
  constructor(
      name: string = '', t: ItemType = ItemType.FILE,
      parent: ProjectViewItem|undefined) {
    super(
        name,
        (t === ItemType.FILE || t === ItemType.CONFIG) ?
...
class FileGroupLevelView extends ProjectViewItem {
  ...
  constructor(group: model.FileGroup, parent: ProjectViewItem) {
    ...
    this.iconPath =
        path.join(__filename, '..', '..', '..', 'icons', 'folder.svg');
  }
...
class ProjectLevelView extends ProjectViewItem {
  ...
  constructor(project: model.Project, parent: ProjectViewItem) {
    ...
    this.iconPath =
        path.join(__filename, '..', '..', '..', 'icons', 'vcxproj.svg');
  }
...
class ConfigLevelView extends ProjectViewItem {
  ...
  constructor(name: string, config: string, parent: ProjectViewItem) {
    ...
    if (config === globals.GlobalVarients.selected_config) {
      this.iconPath =
          path.join(__filename, '..', '..', '..', 'icons', 'check.svg');
    } else {
      this.iconPath =
          path.join(__filename, '..', '..', '..', 'icons', 'file.svg');
    }
...
class ConfigGroupLevelView extends ProjectViewItem {
  ...
  constructor(name: string, configs: string[], parent: ProjectViewItem) {
    ...
    this.model_ = new model.Null();
    this.iconPath =
        path.join(__filename, '..', '..', '..', 'icons', 'packages.svg');
...
export function CreateTopLevel(
    name: string, children: model.Project[],
    configs: string[]): ProjectViewItem {
